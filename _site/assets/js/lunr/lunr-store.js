var store = [{
        "title": "결측값 다루기",
        "excerpt":"데이터 분석을 하면서 필수적으로 하는 작업이 ‘결측값 확인 및 처리’이다. 파이썬에서 어떤 값을 결측으로 인식하는지 확인하고, 결측이 있는 경우 함수들이 어떻게 작용하는지 알아보자. 1. 결측값 확인 우선, 파이썬에서 어떤 값들을 결측으로 인식하는지 알아보자. import numpy as np import pandas as pd a = np.nan b = \"\" c = None...","categories": ["DA"],
